...
const jobTitle = computed(() => {
    switch (currentJob.value) {
        ...
        case 1:
            return "Cloud/Software Intern";
        case 2:
            return "Backend Software Intern";
        default:
            return "Full Stack Software Engineer";
    }
});
...
<template>
    ...
    <div class="w-full h-2/3 flex flex-col justify-start lg:justify-start items-center mt-4 xl:mt-12 gap-8 xl:gap-24">
        ...
        >
            <div class="h-full mt-6 flex flex-col md:flex-row">
                <div class="flex flex-row flex-1">
                    ...
                    <div class="flex flex-row md:flex-col justify-start gap-8">
                        <BlockButton 
                            ...
                            class="w-40 xl:w-80 px-2 py-2 text-black font-medium transition-colors"
                ...
                <Glass class="h-full w-fit mx-auto xl:w-2/3">
                    <div class="w-full flex flex-col gap-4 py-12 px-20">
                        <h1 class="text-xl xl:text-5xl font-extralight">{{ jobTitle }}</h1>
