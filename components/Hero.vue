        ...
        <template #default>
            <div class="flex flex-col gap-8 mx-4 lg:mx-16 my-8 lg:my-24 z-20">
                ...
                <div class="flex flex-col gap-2 w-full justify-center md:justify-start">
                    <BlockButton class="bg-tailwind w-40 xl:w-52 px-3 py-2 text-white" 
                            link="https://github.com/christensenjo">GitHub</BlockButton>
                    <BlockButton class="bg-vue w-40 xl:w-52 px-3 py-2 text-white">Resume</BlockButton>
                    <BlockButton class="bg-laravel w-40 xl:w-52 px-3 py-2 text-white"
                            link="#contact">Contact Me</BlockButton>
                </div>
            </div>
        </template>
        <template #behind>
